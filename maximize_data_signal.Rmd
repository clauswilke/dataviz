...
*argument about the gray background: it creates a similar shading as text.* keep in mind that the perceived grayness of text will depend on the font size, fontface, and line spacing. A scientific paper typeset in dense, 10-point Times New Roman will look very different from a coffee-table book typeset in 14-point Palatino with one-and-a-half line spacing.

*also talk about color choice; a gray background requires stronger colors than a white background.*
