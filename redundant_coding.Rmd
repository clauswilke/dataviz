...
stamp_bad(plot_grid(NULL, iris_scatter + theme_minimal_grid(), NULL,
                    nrow = 1, rel_widths = c(0.02, 1, 0.04)))
```
...
iris %>%
  select(Sepal.Width, Sepal.Length, species = Species) %>%
  ggplot(aes(x = Sepal.Length, y = Sepal.Width, shape = species, fill = species, color = species)) + 
    geom_point(size = 2.5) +
...
stamp_phantom(plot_grid(NULL, iris_scatter2 + theme_minimal_grid(), NULL,
                        nrow = 1, rel_widths = c(0.02, 1, 0.04)))
```
...
stamp_phantom(plot_grid(NULL, iris_scatter3 + theme_half_open(), NULL,
                        nrow=1, rel_widths = c(0.02, .8, 0.24)))
```
