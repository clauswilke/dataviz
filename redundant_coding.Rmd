...
stamp_good(plot_grid(NULL, iris_scatter2 + theme_minimal_grid(), NULL, nrow=1, rel_widths=c(0.02, 1, 0.04)))
```
...
stamp_good(plot_grid(NULL, iris_scatter3 + theme_half_open(), NULL, nrow=1, rel_widths=c(0.02, .8, 0.24)))
```
