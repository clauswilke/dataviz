...
p3 <- ggplot(filter(df_long, as.integer(var1) < as.integer(var2)),
  ...
  scale_fill_gradient2(high = palette[1], mid = palette[npal], low = pal_steel_blue_inv[1], guide = "none") +
