...
Proportions can be visualized as pie charts, side-by-side bars, or stacked bars, the latter arranged either vertically or horizontally (Chapter \@ref(visualizing-proportions)).


```{r proportions-comp, fig.width = 8, fig.asp = 1/4, message = FALSE}
