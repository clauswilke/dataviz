...
```{r amounts, fig.width = 6, fig.asp = 1/4}
...
```{r amounts_multi, fig.width = 6, fig.asp = 1/2}
...
```{r single-distributions, fig.width = 6, fig.asp = 1/4}
...
```{r multiple-distributions, fig.width = 6, fig.asp = 1/2}
palette <- pal_ocean_blue
...
```{r proportions, fig.width = 6, fig.asp = 1/4}
...
```{r proportions-comp, fig.width = 6, fig.asp = 1/4}
...
```{r proportions-multi, fig.width = 6, fig.asp = 1/4}
