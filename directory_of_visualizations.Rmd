...
```{r basic-scatter, fig.width = 6, fig.asp = 1/4}
...
```{r xy-lines, fig.width = 6, fig.asp = 1/4}
...
```{r geospatial, fig.width = 6, fig.asp = 1/4}
...
```{r errorbars, fig.width = 6, fig.asp = 1/4}
...
```{r confidence-dists, fig.width = 6, fig.asp = 1/4}
