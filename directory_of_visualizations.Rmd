...
pad_figure(plot_grid(p1, p2, p7, ncol = 4, scale = .9),
           fig.width = 8)
```
...
```{r amounts_multi, fig.height = 8/2}
pad_figure(plot_grid(p3, p4, p5, p6, 
                     p8, ncol = 4, scale = .9), fig.width = 8)
```
...
```{r single-distributions, fig.height = 8/4}
...
pad_figure(plot_grid(p1, p2, p3, p4, ncol = 4, scale = .9),
           fig.width = 8)
```
...
```{r multiple-distributions, fig.height = 8/2}
palette <- pal_ocean_blue
...
pad_figure(plot_grid(p1, p2, p3, p4, 
...
pad_figure(plot_grid(p1, p4, p5, p2, ncol = 4, scale = .9),
           fig.width = 8)
```
...
```{r proportions-comp, fig.height = 8/4}
...
pad_figure(plot_grid(p8, p5, p6, p7, ncol = 4, scale = .9),
           fig.width = 8)
```
...
```{r fig.height = 8/4, include = FALSE}
## Other
...
pad_figure(plot_grid(p1, ncol = 4, scale = .9), fig.width = 8)
