...
p1 <- ggplot(US_census, aes(x=pop2010)) + 
  ...
  theme_dviz_grid(12) +
  theme(plot.margin = margin(3, 0, 12, 0))
...
```{r student-grades-qq, fig.width = 5, fig.asp = 0.9, fig.cap='(ref:student-grades-qq)'}
...
```{r county-populations-qq, fig.width = 5, fig.asp = 0.9, fig.cap='(ref:county-populations-qq)'}
# estimate distribution parameters (mean and sd)
