...
```{r county-populations, message=FALSE, warning=FALSE, fig.width = 8.5, fig.asp = 0.309, fig.cap='(ref:county-populations)'}
library(openintro)
...
```{r county-populations-log, message=FALSE, warning=FALSE, fig.width = 8.5, fig.asp = 0.309, fig.cap='(ref:county-populations-log)'}
...
```{r county-populations-tail-log-log, message=FALSE, warning=FALSE, fig.cap='(ref:county-populations-tail-log-log)'}
...
```{r word-counts-tail-log-log, message=FALSE, warning=FALSE, fig.cap='(ref:word-counts-tail-log-log)' }
