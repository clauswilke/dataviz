...
Introductory texts in statistics will generally contain material on data visualization, covering topics such as scatter plots, histograms, box plots, and line graphs. There are far too many such texts to provide an exhaustive list. Instead, I list a few recent additions that are worth a closer look.
...
The following books are all broadly related to the topic of data visualization.
