...
pad_figure(stamp_bad(iris_lines))
```
...
pad_figure(stamp_ugly(iris_colored_lines))
```
...
```{r mpg-linespoints, fig.height = 5.5 * 0.7416, fig.cap='(ref:mpg-linespoints)'}
...
pad_figure(stamp_bad(mpg_linespoints), fig.width = 5.5)
```
...
```{r mpg-filledpoints, fig.height = 5.5 * 0.7416, fig.cap='(ref:mpg-filledpoints)'}
...
pad_figure(mpg_filledpoints, fig.width = 5.5)
```
