...
```{r corruption-development-infographic, fig.width = 7, fig.asp = 0.84, fig.cap = '(ref:corruption-development-infographic)'}
...
plot_grid(plot_corrupt_title, grob_corrupt_base, plot_corrupt_caption,
