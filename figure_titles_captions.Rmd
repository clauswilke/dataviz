...
Consider Figure \@ref(fig:corruption-development). This figure is inspired by a posting by @Economist-corruption, to which I have applied several subtle but important modifications. Besides updating the data to a more recent dataset (2015) and adapting the color and symbol styling so they follow the styling used throughout this book, I have incorporated another important deviation from the types of figures commonly displayed in venues such as The Economist: The figure does not have a title, nor does it provide information about the data sources. Instead, the figure is shown with a separate caption that describes the figure and the origin of the data shown. In fact, this is the style I am using throughout this book. None of the figures have integrated titles, and all have separate captions.
