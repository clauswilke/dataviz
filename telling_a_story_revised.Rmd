...
# Using visualizations to tell a story {#telling-a-story}

Most data visualization is done for the purpose of communication. We have an insight about a dataset, and we have a potential audience, and we want to convey our insight to our audience. To communicate our insights successfully, we will have to present the audience with a clear and exciting story. The need for a story may seem disturbing to scientists and engineers, who may equate it with making things up, putting a spin on things, or overselling results. However, this perspective misses a fundamental truth about how human cognition works: All our thinking is based on stories. We get excited when we hear a good story, and we get bored when the story is bad or when there is none. Moreover, any communication creates a story in the audience's minds. If we don't provide a clear story ourselves, then our audience will make one up. In the best-case scenario, the story they make up is reasonably close to our own view of the material presented. However, it can be and often is much worse. The made-up story could be "this is boring," "the author is wrong," or "the author is incompetent."

Your goal in telling a story about data should be to use facts and data to get your audience interested and excited. Let me tell you a story about the theoretical physicist Stephen Hawking. He was diagnosed with motor neuron disease at age 21---one year into his PhD---and was given two years to live. Hawking did not accept this predicament and started pouring all his energy into doing science. Hawking ended up living to be 76, became one of the most influential physicists of his time, and did all of his seminal work while being severely disabled. I'd argue that this is a compelling story. It's also entirely fact-based and true.

## What is a story?

Before we can discuss strategies for turning visualizations into stories, we need to understand what a story actually is. A story is a set of observations, facts, or events, true or invented, that are presented in a specific order such that they create an emotional reaction in the audience. The emotional reaction is created through the build-up of tension at the beginning of the story followed by some type of resolution towards the end of the story. We refer to the flow from tension to resolution also as the story arc, and every good story has a clear, identifiable arc that it follows.

Experienced writers know that there are standard patterns for story telling that  resonate with human cognition. For example, we can tell a story using the Opening--Challenge--Action--Resolution format, and this is exactly the format I used for the Hawking story in the previous subsection. I opened the story by introducing the topic, the physicist Stephen Hawking. Next I presented the challenge, motor neuron disease at age 21. Then came the action, his fierce dedication to science. Finally I presented the resolution, that Hawking led a long and successful life and ended up becoming one of the most influential physicists of his time. Other story formats are also commonly used. Newspaper articles frequently follow the Lead--Development--Resolution format or even just the Lead--Development format, where the lead gives away the main point up front. If we wanted to tell the Hawking story in this format, we might start out with a sentence such as "The influential physicist Stephen Hawking, who revolutionized our understanding of black holes and of cosmology, outlived his doctors' prognosis by 53 years and did all of his most influential work while being severely disabled." This is the lead. In the development, we could follow up with a more detailed description of Hawking's life, illness, and devotion to science. Finally, there is the Action--Background--Development--Climax--Ending format, which develops the story a little more rapidly than the Opening--Challenge--Action--Resolution format but not as rapidly as the Lead--Development--Resolution format. In this format, we might open with a sentence such as "The young Stephen Hawking, facing a debilitating disability and the prospect of an early death, decided to pour all his efforts into his science, determined to make his mark while he still could." The purpose of this story format is to draw the audience in and to create an emotional connection early on, without giving away the final resolution.

My goal in this chapter is not to describe these standard forms of story telling in more detail. There are excellent resources that cover this material. For scientists and analysts, I particularly recommend @Schimel2011. Instead, I want to discuss how we can bring data visualizations into the story arc. Most importantly, we need to realize that a single (static) visualization will rarely tell an entire story. The visualization may illustrate the opening, the challenge, the action, or the resolution, but by itself it is unlikely to convey all these parts of the story at once. To tell a story, we will usually need multiple visualizations. For example, in a research paper, we may present a sequence of figures that lead the reader through the story arc. Likewise, when giving a presentation, we may first show some background or motivational material, then a figure that creates a challenge, and eventually some other figure that provides the resolution. While a figure that represents both challenge and resolution at once is possible, such a figure is comparable to a story arc that starts with a lead, and it will rarely create the same kind of emotional respose as a sequence of multiple figures that first create tension and then provide resolution.

I am now going to present two figures, where the first creates a challenge and the second serves as resolution. The context is the growth of preprints in the biological sciences. Preprints are manuscripts in draft form that scientists share with their colleagues before formal peer review and official publication. Scientists have been sharing manuscript drafts for as long as scientific manuscripts have existed. However, in the early 1990s, with the advent of the internet, physicists realized that it was much more efficient to store and distribute manuscript drafts in a central repository. They invented the preprint server, a web server where scientists can upload, download, and search for manuscript drafts.

The preprint server physicists developed is called arXiv.org. Shortly after it was established, arXiv.org started to branch out and become popular in related quantitative fields, including mathematics, astronomy, computer science, statistics, quantitative finance, and quantitative biology. Here, we are interested in the preprint submissions to the quantitative biology (q-bio) section of arXiv.org. The number of submissions per month grew exponentially from 2007 to late 2013, but then the growth suddenly stopped (Figure \@ref(fig:q-bio-monthly-growth)). Something must have happened in late 2013 that radically changed the landscape in preprint submissions for quantitative biology. What was the cause for this drastic change in submission growth?
...
```{r q-bio-monthly-growth, fig.asp = 0.75, fig.cap = '(ref:q-bio-monthly-growth)'}
...
ggplot(filter(df_preprints, archive == "arXiv q-bio"),
       aes(date, count, color = archive)) + 
  geom_line(size = 0.75) +
  scale_y_log10(limits = c(40, 400), breaks = c(50, 100, 200, 300), expand = c(0, 0),
                name = "preprints / month",
                sec.axis = dup_axis(breaks = df_final_qbio$count,
...
```{r q-bio-bioRxiv-monthly-growth, fig.asp = 0.75, fig.cap = '(ref:q-bio-bioRxiv-monthly-growth)'}
ggplot(df_preprints, aes(date, count, color = archive)) + geom_line(size = 0.75) +
...
I purposefully broke the preprint story into two figures, even though the first (Figure \@ref(fig:q-bio-monthly-growth)) is fully contained within the second (Figure \@ref(fig:q-bio-bioRxiv-monthly-growth)). I think this story has the strongest impact when broken into two pieces, and this is how I would present it in a talk. However, Figure \@ref(fig:q-bio-bioRxiv-monthly-growth) alone can be used to convey the story, in which case it would serve as a lead. Details about the two preprint servers and their respective histories and user bases could then be provided as the development and/or resolution part of the story.

**This needs to be deleted or moved somewhere:** *I have four specific recommendations: (i) prepare figures that make simple and clear points, (ii) build up from simpler to more complex visualizations, (iii) use a consistent visual language, and (iv) don't be repetitive.*
...
p_delay_distance <- ggplot(delay, aes(x = distance, y = arr_delay, color = name, fill = name)) +
  ...
  theme_dviz_grid() +
  theme(plot.margin = margin(3.5, 14, 3.5, 0))
...
filter(flights_grouped, name == "United" & origin == "EWR") %>%
  ggplot(aes(x = wday(time_hour, label = TRUE, week_start = 1))) + 
    ...
    theme(strip.text = element_text(family = dviz_font_family_bold_condensed,
          ...
          plot.title = element_text(family = dviz_font_family_bold_condensed,
                                    hjust = 0.5, vjust = 0.5,
                                    margin = margin(4, 4, 4, 4)))
```
...
ggplot(flights_grouped, aes(x = wday(time_hour, label = TRUE, week_start = 1))) + 
  ...
  scale_x_discrete(labels = c("M", "", "W", "", "F", "", "S"),
                   expand = c(0, 0.05),
                   name = "weekday") +
  theme_dviz_hgrid(12, dviz_font_family_condensed) +
  #panel_border() +
  theme(strip.text = element_text(family = dviz_font_family_bold_condensed,
...
```{r athletes-composite-repetitive, fig.asp = 0.75, fig.cap = '(ref:athletes-composite-repetitive)'}
...
p_row <- plot_grid(p1, p2, labels = "auto", rel_widths = c(0.7, 1)) +
...
stamp_bad(plot_grid(fb_price_plot,
                    all_indexed_price_plot,
                    ncol = 1, align = "v", labels = "auto") +
            theme(plot.margin = margin(14, 7, 0, 0)))
```
