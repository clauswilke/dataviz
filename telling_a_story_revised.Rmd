...
filter(flights_grouped, name == "United" & origin == "EWR") %>%
  ggplot(aes(x = wday(time_hour, label = TRUE, week_start = 1))) + 
    ...
    scale_x_discrete(labels = c("M", "T", "W", "T", "F", "S", "S"),
                     expand = c(0, 0.05),
                     name = "weekday") +
    theme_dviz_hgrid(14, "Myriad Pro Condensed") +
    theme(strip.text = element_text(family = "Myriad Pro Bold Condensed",
          ...
          plot.title = element_text(family = "Myriad Pro Bold Condensed",
                                    hjust = 0.5, vjust = 0.5,
                                    margin = margin(4, 4, 4, 4)))
```
...
ggplot(flights_grouped, aes(x = wday(time_hour, label = TRUE, week_start = 1))) + 
  ...
  scale_x_discrete(labels = c("M", "", "W", "", "F", "", "S"),
                   expand = c(0, 0.05),
                   name = "weekday") +
  theme_dviz_hgrid(12, "Myriad Pro Condensed") +
  #panel_border() +
  theme(strip.text = element_text(family = "Myriad Pro Bold Condensed",
