...
The eventual purpose of most data visualizations is communication: We know something about a dataset that our audience does not, and we want to convey our insights to them. To communicate our insights successfully, we will have to present our audience with a story they can follow. This is a key concept that scientists and analysts often find hard to swallow. They may be put off by the notion, equating it with making things up, putting a spin on things, or overselling results. However, this perspective misses a fundamental truth about how human cognition works: All our thinking is based on stories. We get excited when we hear a good story, and we get bored when the story is bad or when there is none. Moreover, any communication creates a story in the audience's minds. If we don't provide a clear story ourselves, then our audience will make one up. In the best-case scenario, the story they make up is reasonably close to our own view of the material presented. However, it can be and often is much worse. The made-up story could be "this is boring," "the author is wrong," or "the author is incompetent."

Your goal in telling a story with data should be to use facts and data to get your audience interested and excited. As an example, consider the story of the theoretical physicist Stephen Hawking. He was diagnosed with motor neuron disease at age 21---one year into his PhD---and was given two years to live. Hawking did not accept this predicament and started pouring all his energy into doing science. Hawking ended up living to be 76, became one of the most influential physicists of his time, and did all of his seminal work while being severely disabled. I'd argue that this is a compelling story. It's also entirely true.

Good stories tend to be structured according to standard patterns that resonate with human cognition. For example, the Hawking story I just presented follows the Opening--Challenge--Action--Resolution structure. My goal in this chapter is not to describe these standard forms of story telling. There are excellent resources that cover this material [see e.g. @Schimel2011]. Instead, I want to address a few specific issues that tend to arise when we try to tell a story with data visualizations. My recommendations on this topic can be summarized in three points: (i) prepare figures that make simple and clear points, (ii) build up from simpler to more complex visualizations, and (iii) use a consistent visual language but don't be repetitive.


## Make a figure for the generals

Throughout the preceding chapters, I have discussed numerous dos and don'ts of data visualization. However, even if you follow all of them, you might still prepare a figure that confuses your audience. When this happens, the underlying cause is likely one of two common misconceptions: (i) the audience can extract the story from the data presented, without much guiding help; (ii) the audience can rapidly process complex visualizations and can immediatel understand the key trends and relationships that are shown. Neither of these misconceptions is true, and we need to do everything we can to help our readers understand the points we're trying to make and see the same patterns in the data that we see. This usually means less is more. Simplify your figures as much as possible. Remove all features that are tangential to your story. Only the important points should remain. I refer to this concept as "making a figure for the generals."
...
The first thing that will get in the way of making a figure for the generals is, ironically, the ease with which modern visualization softwares allow us to make multi-dimensional figures. With nearly limitless power of visualization, it becomes tempting to keep piling on more dimensions of data. And in fact, I see a trend in the world of data visualization to make the most complex, multi-faceted visualizations possible. These visualizations may look very impressive, but they are unlikely to convey a clear story. Consider Figure \@ref(fig:arrival-delay-vs-distance), which shows the arrival delays for all flights departing out of the New York City area in 2013. I suspect it will take you a while to process this figure.
