...
```{r price-plot-ggplot-default, message=FALSE, warning=FALSE, fig.cap='(ref:price-plot-ggplot-default)'}
...
```{r price-plot-refline, warning=FALSE, fig.cap='(ref:price-plot-refline)'}
...
```{r iris-scatter, fig.cap='(ref:iris-scatter)'}
iris %>%
...
```{r echave-et-al, message=FALSE, warning=FALSE, fig.cap='(ref:echave-et-al)'}
...
```{r echave-et-al-grid, message=FALSE, warning=FALSE, fig.cap='(ref:echave-et-al-grid)'}
