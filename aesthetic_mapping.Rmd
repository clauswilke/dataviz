...
```{r common-aesthetics, fig.height = 0.45*7.5, fig.cap = '(ref:common-aesthetics)'}
aes_pos <- ggdraw() + 
...
```{r basic-scales-example, fig.height = 5.5 * 0.3, fig.cap = '(ref:basic-scales-example)'}
...
pad_figure(scales_grob, fig.width = 5.5)
```
...
```{r four-locations-temps-by-month, fig.height = 8.5 * 0.3, fig.cap = '(ref:four-locations-temps-by-month)'}
...
```{r mtcars-five-scale, fig.height = 7 * 0.8, fig.cap = '(ref:mtcars-five-scale)'}
