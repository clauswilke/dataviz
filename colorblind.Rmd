...
Throughout this book, I'm using the following color palette, which was developed to work well for all the major types of colorblindness:
...
Table: (\#tab:color-codes) Colorblind-friendly color scale, developed by Masataka Okabe and Kei Ito. 
