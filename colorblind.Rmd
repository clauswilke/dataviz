...
df <- data.frame(x = rep(x, 4),
                 type = rep(LETTERS[1:4], each=100))

optA <- ggdraw() +
  geom_ridgeline_gradient(data = data.frame(x = seq(0, 1, length.out = 100)),
                    aes(x, y = 0, height = 1, fill = x),
                    color = "transparent") +
...
ggdraw(ylim = c(0.05, 0.9)) +
  draw_text(text = "Viridis", x = 0.1, y = .8, hjust = 0, vjust = -.5, size = 12) +
  draw_plot(optD, x = 0.1, y = 0.7, height = 0.1, width = 0.8) +
  draw_text(text = "Magma", x = 0.1, y = .6, hjust = 0, vjust = -.5, size = 12) +
  draw_plot(optA, x = 0.1, y = 0.5, height = 0.1, width = 0.8) +
  draw_text(text = "Inferno", x = 0.1, y = .4, hjust = 0, vjust = -.5, size = 12) +
  draw_plot(optB, x = 0.1, y = 0.3, height = 0.1, width = 0.8) +
  draw_text(text = "Plasma", x = 0.1, y = .2, hjust = 0, vjust = -.5, size = 12) +
  draw_plot(optC, x = 0.1, y = 0.1, height = 0.1, width = 0.8)
