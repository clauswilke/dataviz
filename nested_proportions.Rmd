...
ggplot(bridges_tidy) +
  aes(x = erected, y = count, width = sqrt(group_count), fill = material) +
...
```{r bridges_treemap, fig.asp = 3/4}
filcols <- c("#D55E00", "#0072B2", "#009E73")
...
ggplot(bridges_tidy, aes(area = count, subgroup = material, fill = interaction(erected, material))) +
  ...
  geom_treemap_subgroup_text(
    family = dviz_font_family,
    colour = rep(c("grey50", "grey70", "grey50"), 4),
  ...
  scale_color_manual(values = c(
    ...
    mature.iron = "black", mature.steel = "white", mature.wood = "black",
