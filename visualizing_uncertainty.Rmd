...
blue_jays_base <- ggplot(blue_jays, aes(Mass, Head)) + 
  scale_fill_gradient(low = "grey95", high = "grey60", guide = "none") +
  scale_x_continuous(
    limits = c(56, 84),
    expand = c(0, 0),
    name = "body mass (g)") +
...
blue_jays_base + 
  stat_density_2d(color = "black", size = 0.2) +
  geom_point(color = "#0072B2", size = .75)

blue_jays_base + 
  stat_density_2d(aes(fill = ..level..), geom = "polygon", color = "black", size = 0.2) +
  geom_point(color = "#0072B2", size = .75)

blue_jays_base + 
  aes(color = KnownSex) +
  stat_density_2d(size = 0.3) +
  geom_point(size = .75) +
  scale_color_manual(
...
p <- ggplot(diamonds, aes(carat, price, color = cut)) + 
  geom_density2d(size = .2, na.rm = TRUE) +
  scale_x_continuous(
    limits = c(-.4, 4.4), expand = c(0, 0)
  ) +
  scale_y_log10(
    limits = c(200, 25000),
    breaks = c(300, 1000, 3000, 10000),
...
ggplot(diamonds, aes(carat, price)) + 
  geom_density2d(color = "#0072B2", size = .2, na.rm = TRUE) +
  scale_x_continuous(
    limits = c(-.4, 4.4), expand = c(0, 0)
  ) +
  scale_y_log10(
