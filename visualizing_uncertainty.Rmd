...
Caps at the ends of error bars can ... [@Skau_et_al_2015]
...
Error bars can be added to a variety of different types of plots to indicate uncertainty. For example, we can show amounts with uncertainty by drawing a bar plot with error bars (Figure \@ref(fig:butterfat-bars)). This type of visualization is commonly used in scientific publications. We can also draw error bars along both the *x* and the *y* direction in a scatter plot (Figure \@ref(fig:median-age-income)). 
...
(ref:bayes-vs-ols) *Figure caption goes here.* The estimates and confidence intervals labeled "ordinary least squares" are identical to the results for 95% confidence shown in Figure \@ref(fig:mean-chocolate-ratings). 
...
(ref:bayes-ridgeline) *Figure caption goes here.*
