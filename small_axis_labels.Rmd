...
stamp_ugly(p + geom_point(size = 1.5) +
             theme_dviz_grid(10) + theme(plot.margin = margin(7, 7, 3, 0)))
```
...
p + geom_point(size = 2.25) +
  theme_dviz_grid() + theme(plot.margin = margin(7, 7, 3, 0))
```
...
stamp_ugly(p + geom_point(size = 2.25) +
             theme_dviz_grid(19) + theme(plot.margin = margin(7, 7, 3, 0)))
```
