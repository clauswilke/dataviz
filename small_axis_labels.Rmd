...
```{r mpg-small, fig.width=5, fig.asp=.7416, fig.cap='(ref:mpg-small)'}
...
```{r mpg-ugly, fig.width=5, fig.asp=.7416, fig.cap='(ref:mpg-ugly)'}
stamp_ugly(p + theme_half_open(10) +
  theme(legend.position = c(.7, .8)))
```
...
```{r mpg-good, fig.width=5, fig.asp=.7416, fig.cap='(ref:mpg-good)'}
stamp_phantom(p +
  theme(legend.position = c(.7, .8)))
```
...
```{r mpg-big-ugly, fig.width=5, fig.asp=.7416, fig.cap='(ref:mpg-big-ugly)'}
stamp_ugly(p + theme_half_open(19) +
...
```{r mpg-big-good, fig.width=5, fig.asp=.7416, fig.cap='(ref:mpg-big-good)'}
