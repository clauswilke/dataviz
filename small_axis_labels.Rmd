...
```{r Aus-athletes-small, fig.height = 7 * 0.618, fig.cap='(ref:Aus-athletes-small)'}
...
pad_figure(stamp_bad(p + theme_minimal_grid(7) + theme(plot.margin = margin(7, 14, 7, 7))),
           fig.width = 7)
```
...
```{r Aus-athletes-ugly, fig.height = 7 * 0.618, fig.cap='(ref:Aus-athletes-ugly)'}
pad_figure(stamp_ugly(p + theme_minimal_grid(10) + theme(plot.margin = margin(7, 14, 7, 7))),
           fig.width = 7)
```
...
```{r Aus-athletes-good, fig.height = 7 * 0.618, fig.cap='(ref:Aus-athletes-good)'}
pad_figure(p + theme_minimal_grid() + theme(plot.margin = margin(7, 14, 7, 7)),
           fig.width = 7)
```
...
```{r Aus-athletes-big-ugly, fig.height = 7 * 0.618, fig.cap='(ref:Aus-athletes-big-ugly)'}
pad_figure(stamp_ugly(p + theme_minimal_grid(19)), fig.width = 7)
```
...
```{r Aus-athletes-big-good, fig.height = 7 * 0.618, fig.cap='(ref:Aus-athletes-big-good)'}
