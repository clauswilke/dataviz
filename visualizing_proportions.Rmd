...
```{r marital-vs-age-proportions, fig.width = 8.5, fig.asp = 0.35, fig.cap='(ref:marital-vs-age-proportions)'}
df_marital2 <- rbind(
  mutate(df_marital,
...
ggplot(df_marital2, aes(age)) +
  geom_density_line(aes(y = stat(count), fill = marital), color = "transparent", position = "fill") +
  ...
  scale_fill_manual(
    values = c("#b3b3b3a0", "#2b8cbed0", "#2b8cbed0", "#2b8cbed0", "#2b8cbed0"),
    name = NULL,
