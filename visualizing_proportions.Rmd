...
```{r, bundestag-stacked-bars, fig.width = 8.5, fig.cap='(ref:bundestag-stacked-bars)'}
...
plot_base <- ggplot(women_rwanda, aes(x = year, y = percent, fill = gender)) +
    ...
    scale_y_continuous(expand = c(0, 0)) +
    scale_fill_OkabeIto(guide = "none", darken = c(0.1, -0.2)) +
    theme_half_open() + 
...
(ref:health-vs-age-facets) Health status by age, shown as proportion of the total number of people in the survey. The colored areas show the density estimates of the ages of people with the respective health status, respectively, and the gray areas show the overall age distribution.

```{r health-vs-age-facets, fig.width = 8.5, fig.asp = 0.35, fig.cap='(ref:health-vs-age-facets)'}
...
```{r marital-vs-age-facets, fig.width = 8.5, fig.asp = 0.35, fig.cap='(ref:marital-vs-age-facets)'}
