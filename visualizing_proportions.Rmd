...
```{r, bundestag-pie, message=FALSE, warning=FALSE, fig.cap='(ref:bundestag-pie)'}
...
```{r health-vs-age-facets, fig.width = 8.5, fig.asp = 0.3, fig.cap='(ref:health-vs-age-facets)'}
ggplot(mutate(df_health, health = fct_rev(health)), aes(x = age, y = ..count..)) +
  geom_density_line(data=select(df_health, -health), color = "transparent") +
  geom_density_line(fill = "#2b8cbe", color = "transparent") +
...
```{r marital-vs-age-facets, fig.width = 8.5, fig.asp = 0.3, fig.cap='(ref:marital-vs-age-facets)'}
ggplot(mutate(df_marital, marital = fct_rev(marital)), aes(x = age, y = ..count..)) +
  geom_density_line(data=select(df_marital, -marital), color = "transparent") +
  geom_density_line(fill = "#2b8cbe", color = "transparent") +
