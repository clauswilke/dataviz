...
A poplar approach to add slickness and polish to visualiations is to turn the figure elements into three-dimensional objects. The most ... 3d pie chart; columns instead of bars; bands instead of lines. These are unequivocally bad and should be erased from the visual vocabulary of data scientists.
